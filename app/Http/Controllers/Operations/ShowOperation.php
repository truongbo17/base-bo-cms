...
trait ShowOperation
{
    ...
    public function show($id)
    {
        ...
        $check = $this->crud->get('show.softDeletes');
        if (isset($this->show_soft_delete)) {
            $check = $this->show_soft_delete;
        }

        // get the info for that entry (include softDeleted items if the trait is used)
        if ($check && in_array('Illuminate\Database\Eloquent\SoftDeletes', class_uses($this->crud->model))) {
